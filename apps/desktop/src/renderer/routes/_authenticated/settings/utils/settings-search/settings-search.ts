...
export const SETTING_ITEM_ID = {
	...
	BEHAVIOR_WORKSPACE_AGENTS: "behavior-workspace-agents",
	...
	INTEGRATIONS_PR_TEAM: "integrations-pr-team",
...
export const SETTING_ITEM_VARIANT: Record<SettingItemId, SettingVariant> = {
	...
	[SETTING_ITEM_ID.INTEGRATIONS_JIRA]: "shared",
	[SETTING_ITEM_ID.INTEGRATIONS_PR_TEAM]: "shared",
	...
	[SETTING_ITEM_ID.BEHAVIOR_WORKSPACE_AGENTS]: "v2",
...
export const SETTINGS_ITEMS: SettingsItem[] = [
	...
	},
	{
		...
		description: "Show items that need your attention",
		keywords: [
			"features",
			"toggle",
			"enable",
	...
	},
	{
		...
		section: "behavior",
		title: "Jira",
		description: "Show or hide Jira controls",
		keywords: [
			"features",
			"toggle",
			"switch",
	...
	},
	{
		...
		section: "behavior",
		title: "Pull requests",
		description: "Show or hide Pull requests controls",
		keywords: [
			"features",
			"toggle",
			"switch",
	...
	},
	{
		...
		section: "behavior",
		title: "Pages",
		description: "Show or hide Pages controls",
		keywords: [
			"features",
			"toggle",
			"switch",
	...
	{
		id: SETTING_ITEM_ID.INTEGRATIONS_PR_TEAM,
		section: "integrations",
		title: "My team",
		description: "Choose teammates for your pull request filter on this device",
		keywords: [
			"team",
			"teammates",
			"members",
	...
	{
		id: SETTING_ITEM_ID.INTEGRATIONS_JIRA,
		section: "integrations",
		title: "Jira",
		description:
			"Configure your Jira connection, team board and GitHub PR source",
		keywords: [
			"jira",
			"atlassian",
			"board",
	...
	},
	{
		...
		description:
			"Setup, worktree close, and run lifecycle scripts for workspaces",
		keywords: [
			"project",
			"scripts",
			"setup",
